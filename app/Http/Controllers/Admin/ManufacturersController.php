...
class ManufacturersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.manufacturers.index', ['include' => 'search.table', 'manufacturers' => $manufacturers, 'manufacturerCount' => $manufacturerCount])->render();
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            ...
            'code_product'	=>	'required' //обязательно
        ]);
